...
- 스케줄러는 PM2 프로세스 안에서 아침 브리핑과 내일 날씨 DM을 발송합니다.
...
- 아침 브리핑: 매일 06:30 KST에 `ADMIN_ID` 관리자 DM으로 오늘 날씨, 긱뉴스 상단 기사 번역, 서버 디스크·메모리 상태를 한 번에 보냅니다.
...
| `src/core/scheduler/private-scheduler.ts` | 아침 브리핑/내일 날씨 DM 스케줄러 |
