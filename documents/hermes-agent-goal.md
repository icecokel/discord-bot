...
Hermes는 관리자 작업을 보조하는 세션형 에이전트다.
...
관리자 DM에서는 Hermes session을 사용한다. 이 영역은 단순 질의응답보다 실제 작업 조사가 중요하다.
...
- 관리자 DM은 Hermes session으로 연속 작업 맥락을 유지한다.
...
- 관리자 DM은 Hermes session을 사용해 이전 맥락을 이어간다.
